...
contract StarNotary is ERC721 {
        ...
        returns (string memory)
    {
        ...
        require(bytes(star.name).length > 0, "The Star is not referenced");
        return star.name;
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        require(
            ...
            "Exchange caller is not owner nor approved of one of the tokens"
        );
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        require(
            ...
            "Transfer star caller is not owner nor approved of the token"
        );
